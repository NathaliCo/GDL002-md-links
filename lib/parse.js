...
// //Stream the file, get the lines and search the links in the lines
//   whatLine: function (arrayLinks, pathFile){
//     return new Promise((resolve, reject) => {
//     //stream file
//     let streamFile = readline.createInterface({
//       input: fs.createReadStream(pathFile)
//     });
//     //Search the links
//     arrayLinks.forEach((link) => { 
//       let lineNo = 1;
//       streamFile.on('line', function (line) {
//         let actualLink = link.href;
//         if (line.search(actualLink)!=-1){
//           link.line=lineNo;
...
//      });
//   },
//Search if the link exists and get the HTML
